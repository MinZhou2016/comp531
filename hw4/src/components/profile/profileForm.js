    ...
    render() { return (
        <form onSubmit={(e) => {
            ...
            const payload = {
                ...
                gender:this.gender.value == this.oldGender? '' : this.gender.value,
            ...
            <div className="form-group row">
                <label className="col-sm-3 form-control-label" for="dob">Gender</label>
                <div className="col-sm-6">
                    <input className="form-control" id="dob" type="text" placeholder={this.props.oldGender}
                        ref={(node) => this.gender = node }/>
                </div>
            </div>            
            <div className="form-group row">
...
ProfileForm.propTypes = {
    ...
    oldGender: PropTypes.string.isRequired,
...
export default connect(
    (state) => {
        return {
            ...
            oldGender: state.profile.gender
        }
    }
)(ProfileForm)
