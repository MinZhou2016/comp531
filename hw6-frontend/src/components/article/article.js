			...
			<div className="article">
				<div className="media">
				  ...
				  <div className="media-body">
				    <h4 className="author media-heading">{author}</h4>
				...
				<div className="btn-group btn-group-justified" role="group" aria-label="...">
				  <div className="btn-left btn-group" role="group">
				    ...
				    }}><i className="fa fa-list" aria-hidden="true"></i> Comments</button>
				  </div>
				  <div className="btn-group" role="group">
				    ...
				    }}><i className="fa fa-commenting-o fa-lg" aria-hidden="true"></i> Add Comment</button>
				  </div>
				  {
				  	!(username === author)? '':
				  	<div className="btn-group btn-right" role="group">
				    	<button type="button" className="btn btn-default editArticle-btn" onClick={() => {
				    		if(newArticle && newArticle !== ''){
				    			editArticle(_id,newArticle);
				    			newArticle = '';
				    		}
				    	}}><i className="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i> Edit</button>
				    </div> 
				  }
				</div>
				{
